...
var lottery = {
	...
	_stop: function () {
		...
		var indexvalue=this.options.target;
		var tt=$("[lottery-unit-index="+indexvalue+"]").find("p").text();
		$("#zhongjiang").show();
		$("#zhongjiang h2").text(tt);
		/*switch(indexvalue)
		{
		case 1:
		  $("#zhongjiang").show();
		  $("#zhongjiang h2").text("红玫瑰一束");
		  break;
		case 2:
		  $("#zhongjiang").show();
		  $("#zhongjiang h2").text("绿萝一束");
		  break;
		case 3:
		  $("#zhongjiang").show();
		  $("#zhongjiang h2").text("香槟玫瑰一束");
		  break;
		case 4:
		  $("#nozhongjiang").show();
		  $("#nozhongjiang h2").text("谢谢参与");
		  break;
		case 5:
		  $("#zhongjiang").show();
		  $("#zhongjiang h2").text("红掌一束");
		  break;
		case 6:
		  $("#zhongjiang").show();
		  $("#zhongjiang h2").text("百合一扎");
		  break;
		case 7:
		  $("#zhongjiang").show();
		  $("#zhongjiang h2").text("情人草一束");
		  break;
		default:
		  $("#nozhongjiang").show();
		  $("#nozhongjiang h2").text("谢谢参与");
